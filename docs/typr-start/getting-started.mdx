...
export const Highlight = ({children, color, link, fontSize = "40px"}) => {
  const spanStyle = {
...
<Highlight color="#c71c3a" link="https://www.youtube.com/watch?v=xLoFlHbDQfc">Watch Video</Highlight>
...
<Highlight color="#c71c3a" link="https://github.com/fabriceHategekimana/typr_runner">typr.runner</Highlight> 
